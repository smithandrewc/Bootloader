...
#
TARGETS			 = px4fmu_bl px4fmuv2_bl px4flow_bl stm32f4discovery_bl px4io_bl aerodroidv2_bl
...
aerodroidv1_bl: $(MAKEFILE_LIST)
	make -f Makefile.f4 TARGET=aerodroidv1 INTERFACE=USB BOARD=AERODROIDV1 USBDEVICESTRING="\\\"PX4 BL AERODROID\\\"" USBPRODUCTID="0x0001"

aerodroidv2_bl: $(MAKEFILE_LIST)
	make -f Makefile.f4 TARGET=aerodroidv2 INTERFACE=USB BOARD=AERODROIDV2 USBDEVICESTRING="\\\"PX4 BL AERODROID\\\"" USBPRODUCTID="0x0001"
